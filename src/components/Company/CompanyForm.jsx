...
const CompanyForm = () => {
  ...
  const initialState = { id: 0, name: "", foundation: 2022, website: "" };
    ...
    <div className="col-md-3 mx-auto">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-3">
          ...
          <input type="number" name="foundation" value={company.foundation} onChange={handleInputChange} className="form-control" min="1500" max="3000" required />
        </div>
        <div className="mb-3">
